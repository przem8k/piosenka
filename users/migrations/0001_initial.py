...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SongAddedAction'
        db.create_table('users_songaddedaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
        ...
        db.send_create_signal('users', ['SongAddedAction'])

        # Adding model 'EventAddedAction'
        db.create_table('users_eventaddedaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ))
        db.send_create_signal('users', ['EventAddedAction'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SongAddedAction'
        db.delete_table('users_songaddedaction')

        # Deleting model 'EventAddedAction'
        db.delete_table('users_eventaddedaction')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 2, 21, 43, 840516)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 2, 21, 43, 840424)'}),
