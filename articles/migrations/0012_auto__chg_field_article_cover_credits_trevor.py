...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.cover_credits_trevor'
        db.alter_column('articles_article', 'cover_credits_trevor', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Article.cover_credits_trevor'
        db.alter_column('articles_article', 'cover_credits_trevor', self.gf('django.db.models.fields.TextField')(default=''))
