...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('articles_article', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 17, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Article.date'
        db.alter_column('articles_article', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
