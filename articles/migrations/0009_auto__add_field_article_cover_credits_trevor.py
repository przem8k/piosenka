...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.cover_credits_trevor'
        db.add_column('articles_article', 'cover_credits_trevor',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.cover_credits_trevor'
        db.delete_column('articles_article', 'cover_credits_trevor')
