...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('articles_article', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['slug']
        db.delete_unique('articles_article', ['slug'])
    ...
    models = {
        'articles.article': {
            ...
            'cover_credits_trevor': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'cover_image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
