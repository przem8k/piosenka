...
class SongTest(GenericTestsMixin, TestCase):
    ...
    def test_add_song_empty_form(self):
        ...
        self.assertFormError(response, "form", "capo_fret", "To pole jest wymagane.")
        self.assertFormError(response, "form", "lyrics", "To pole jest wymagane.")
        self.assertFormsetError(
            response, "entitycontribution", 0, "artist", "To pole jest wymagane."
        )
        self.assertFormsetError(
            response,
            "entitycontribution",
