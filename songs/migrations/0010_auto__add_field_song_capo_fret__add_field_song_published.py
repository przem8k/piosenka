...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.capo_fret'
        db.add_column('songs_song', 'capo_fret', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Song.published'
        db.add_column('songs_song', 'published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.capo_fret'
        db.delete_column('songs_song', 'capo_fret')

        # Deleting field 'Song.published'
        db.delete_column('songs_song', 'published')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 20, 0, 33, 11, 105203)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 20, 0, 33, 11, 105105)'}),
