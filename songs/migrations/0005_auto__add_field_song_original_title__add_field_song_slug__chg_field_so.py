...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.original_title'
        db.add_column('songs_song', 'original_title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Song.slug'
        db.add_column('songs_song', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, db_index=True), keep_default=False)

        # Changing field 'Song.title'
        db.alter_column('songs_song', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Song.disambig'
        db.alter_column('songs_song', 'disambig', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Song.original_title'
        db.delete_column('songs_song', 'original_title')

        # Deleting field 'Song.slug'
        db.delete_column('songs_song', 'slug')

        # Changing field 'Song.title'
        db.alter_column('songs_song', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Song.disambig'
        db.alter_column('songs_song', 'disambig', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
