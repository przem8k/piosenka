...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Song.description'
        db.delete_column('songs_song', 'description')

        # Deleting field 'Song.created'
        db.delete_column('songs_song', 'created')

        # Deleting field 'Song.original'
        db.delete_column('songs_song', 'original_id')

        # Deleting field 'Song.remarks'
        db.delete_column('songs_song', 'remarks')


    def backwards(self, orm):
        
        # Adding field 'Song.description'
        db.add_column('songs_song', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.created'
        db.add_column('songs_song', 'created', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.original'
        db.add_column('songs_song', 'original', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['songs.Song'], null=True, blank=True), keep_default=False)

        # Adding field 'Song.remarks'
        db.add_column('songs_song', 'remarks', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
