...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name('songs_song_related_songs'))


    def backwards(self, orm):
        # Adding M2M table for field related_songs on 'Song'
        m2m_table_name = db.shorten_name('songs_song_related_songs')
        ...
        db.create_unique(m2m_table_name, ['from_song_id', 'to_song_id'])
