...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Song.new_slug'
        db.alter_column('songs_song', 'new_slug', self.gf('django.db.models.fields.SlugField')(max_length=100, unique=True, null=True))
    ...
    models = {
        ...
        'songs.song': {
            ...
            'new_slug': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'null': 'True', 'unique': 'True', 'blank': 'True'}),
