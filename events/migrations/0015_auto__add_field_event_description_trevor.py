...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.description_trevor'
        db.add_column('events_event', 'description_trevor',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.description_trevor'
        db.delete_column('events_event', 'description_trevor')
