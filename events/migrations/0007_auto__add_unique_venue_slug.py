...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Venue', fields ['slug']
        db.create_unique('events_venue', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Venue', fields ['slug']
        db.delete_unique('events_venue', ['slug'])
