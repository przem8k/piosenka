...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntityPerformance'
        db.create_table('events_entityperformance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artists.Entity'])),
        ))
        db.send_create_signal('events', ['EntityPerformance'])


    def backwards(self, orm):
        # Deleting model 'EntityPerformance'
        db.delete_table('events_entityperformance')
    ...
    models = {
        'artists.artist': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['artists.Entity']", 'null': 'True', 'blank': 'True'}),
        ...
        'artists.band': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['artists.Entity']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['artists.Artist']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'events.event': {
            ...
            'artists': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['artists.Artist']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'bands': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['artists.Band']", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_html': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_trevor': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
