...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.post_trevor'
        db.add_column('blog_post', 'post_trevor',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Post.more_trevor'
        db.add_column('blog_post', 'more_trevor',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.post_trevor'
        db.delete_column('blog_post', 'post_trevor')

        # Deleting field 'Post.more_trevor'
        db.delete_column('blog_post', 'more_trevor')
    ...
    models = {
        ...
        'blog.post': {
            ...
            'more_trevor': ('django.db.models.fields.TextField', [], {}),
            'post': ('django.db.models.fields.TextField', [], {}),
            'post_html': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'post_trevor': ('django.db.models.fields.TextField', [], {}),
