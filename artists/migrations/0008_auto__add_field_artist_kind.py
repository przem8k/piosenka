...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.kind'
        db.add_column('artists_artist', 'kind', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.kind'
        db.delete_column('artists_artist', 'kind')
