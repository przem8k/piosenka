...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Band.slug'
        db.alter_column('artists_band', 'slug', self.gf('django.db.models.fields.SlugField')(default='void', unique=True, max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Band.slug'
        db.alter_column('artists_band', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100, null=True))
